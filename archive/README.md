...
Superseded and exploratory documents, kept for history. **Nothing here is authoritative.** If anything here disagrees with the code or with `docs/`, the code and `docs/` win.

Current documentation starts at [`docs/OVERVIEW.md`](../docs/OVERVIEW.md).
...
Phase 13 (deferred) and the LSP plan are **not** here — they are live remaining-work specs under `docs/planning/`.
