...
- **Current**: the 2026-06-10 architecture migration (see "Current Project" above) — 48 tasks across 8 phases, ending with the `sax` monorepo tagged v1.0.
