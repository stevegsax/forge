...
- **Current**: the 2026-06-10 architecture migration (see "Current Project" above) — 56 tasks (a standalone Phase 0 plus 8 migration phases); Phases 1–3 are complete and Phase 4 is next. The migration ends with the forge monorepo tagged v1.0 (T8.4's final sweep — not before).
