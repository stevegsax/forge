...
- [Schedules — Python SDK](https://docs.temporal.io/develop/python/workflows/schedules) — the forge worker creates a single Temporal Schedule at startup, `forge-batch-poller` (D81); see the SDK [schedule sample](https://github.com/temporalio/samples-python/blob/4d453de6adce21be822a02e2dc553138b684945d/schedules/start_schedule.py). *(The shared-poller schedule is interim: Phase 4, per D88, replaces it with per-workflow timer-loop polling.)*
