...
# Planning is a thinking-enabled call (D94): adaptive thinking now competes
# for tokens inside max_tokens instead of riding on top of it, so this is
# sized for adaptive thinking + structured output on the batch lane;
